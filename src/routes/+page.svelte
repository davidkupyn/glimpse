<script lang="ts">
	...
	const shapes = [
		...
		'M79.4 -90.5C118.2 -40.5 175.6 -20.3 200.2 24.6C224.9 69.5 216.7 139.1 177.9 145.3C139.1 151.6 69.5 94.5 4.1 90.4C-61.3 86.3 -122.6 135.1 -157.7 128.8C-192.9 122.6 -201.9 61.3 -186.6 15.3C-171.3 -30.6 -131.6 -61.3 -96.4 -111.3C-61.3 -161.3 -30.6 -230.6 -5.2 -225.5C20.3 -220.3 40.5 -140.5 79.4 -90.5',
